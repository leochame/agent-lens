...
function buildUiApi(): {
  taskRuntimeUi: (task: { enabled?: boolean; workflowLoopFromStart?: boolean }, runtimeState: string) => {
    toggleLabel: string;
    runtimeHint: string;
    runLabel: string;
  };
  toggleResultMessage: (taskEnabledBefore: boolean, runtimeState: string) => string;
} {
